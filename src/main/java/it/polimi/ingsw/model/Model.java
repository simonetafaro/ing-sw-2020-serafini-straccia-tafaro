...
public class Model extends Observable<Object> {
     ...
     * @param color1
     * @param color2
     * @param color3 Populate playOrder_List and assign to turn the first player
     */
    ...
    /**
     * @param color1
     * @param color2 Populate playOrder_List and assign to turn the first player
     */
     ...
     * @param p1
     * @param p2
     * @param p3 Populate players list
     */
    ...
    /**
     * @param p1
     * @param p2 Populate players list
     */
    ...
    /**
     * @param level Assign int to level (0 or 1)
     */
    ...
    /**
     * @param worker Set workers instance to each player
     */
    ...
    /**
     * @param worker Notify RemoteView when is time to set workers on the board
     */
    ...
    /**
     * @param move
     * @param hasWon notify RemoteView at the end of each Step (move or build)
     */
    ...
    /**
     * @param message notify to remoteView
     */
    ...
    /**
     * @param s Notify RemoteView when there are errors during game
    ...
    /**
     * @param move remove player present in move from game, because he is stuck, so he can't move his workers
     */
    ...
    /**
     * @param color remove playerColor of player that has been deleted from game
     */
    ...
    /**
     * @param move Notify remoteView that game is over because one player is stuck, so the opponent win
     */
     ...
     * @param move
     * @param turn
     * @param model Fill step information after move or build
     */
    ...
    /**
     * @param move
     * @param turn If it is the first step of this turn sets the worker that must be the same for each step of this turn
     */
