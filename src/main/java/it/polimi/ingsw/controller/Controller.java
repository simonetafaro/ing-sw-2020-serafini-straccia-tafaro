...
public class Controller implements Observer<Object> {
    ...
    /**
     * @param model
     * Controller constructor, assign model to controller
     */
    ...
    /**
     * @param turn
     * set Turn in controller, used for manage game
     */
    ...
    /**
     * @param move
     * This method assign to "move" player and worker object of the model.
    ...
    /**
     * @param message
     * Observer-Observable pattern, this method run when notify in RemoteView is called
     */
    @Override
    ...
    /**
     * @param worker
     * Manage setup of workers position on the board for the first time
     */
