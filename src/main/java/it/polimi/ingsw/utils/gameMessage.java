...
public class gameMessage {
    ...
    public static String moveMessage = "Which worker do you want to move [1-(x,y)]:";
    public static String moveAgainMessage = "Please choose another cell [1-(x,y)]:";
    ...
    public static String tooHighCellMessage = "The chosen cell is not empty!";
