...
class ChronusRuleDecoratorTest {
    private ChronusRuleDecorator chronusRuleDecorator =new ChronusRuleDecorator();
    ...
    void playNotEndAllowed() {
        ...
        chronusRuleDecorator.play(playerMoveEnd,turn,model);
